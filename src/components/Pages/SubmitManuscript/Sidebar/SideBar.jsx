  ...
  },
  {
    ...
    image: (
      ...
      >
        ...
        />
        <path
          d="M6 4V20C6 21.1 6.9 22 8 22H16C17.1 22 18 21.1 18 20V4C18 2.9 17.1 2 16 2H8C6.9 2 6 2.9 6 4Z"
          stroke="#B2ABAB"
          stroke-width="1.5"
          stroke-linecap="round"
          stroke-linejoin="round"
...
const SideBar = ({
  ...
  const handleItemClick = (id) => {
    ...
    // Check if the sideBar-nav-active class is present
    const isClassPresent =
      itemContainer.classList.contains("sideBar-nav-active");

    // Toggle the active state only if the class is not present
    if (!isClassPresent) {
          ...
          <div className={`${darkModeTheme ? "light-theme-container" : ""}`}>
            ...
            >
              <path
                ...
                fill={darkModeTheme ? "white" : "#B2ABAB"}
              />
              <path
